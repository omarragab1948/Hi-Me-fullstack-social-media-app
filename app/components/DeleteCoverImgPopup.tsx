...
import { deleteCoverImage } from "../services/apiHandler";
import { useDispatch } from "react-redux";
import { setUser } from "../rtk/userSlice";
import CloseIcon from "@mui/icons-material/Close";
export default function DeleteCoverImgPopup({ openPopup, setOpenPopup }) {
  const handleClose = () => {
    setOpenPopup(false);
  };
  ...
  const handleDelete = async () => {
    setSpinner(true);
    try {
      const res = await deleteCoverImage("658f9e8ee14bbc778198f52c");
